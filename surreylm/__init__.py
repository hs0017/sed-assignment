...
def create_app(database_uri=f'mysql+mysqlconnector://{db_username}:{db_password}@surreylm-db.mysql.database.azure.com:3306/{DB_NAME}?ssl_ca={ca_cert}&ssl-mode=REQUIRED'):
    """
